...
import co.cima.agrofinca.config.Constants;
import co.cima.agrofinca.domain.User;
import co.cima.agrofinca.repository.AuthorityRepository;
import co.cima.agrofinca.repository.UserRepository;
import co.cima.agrofinca.security.AuthoritiesConstants;
import co.cima.agrofinca.service.UserService;
import co.cima.agrofinca.service.dto.PasswordChangeDTO;
import co.cima.agrofinca.service.dto.UserDTO;
import co.cima.agrofinca.web.rest.vm.KeyAndPasswordVM;
import co.cima.agrofinca.web.rest.vm.ManagedUserVM;
...
import static co.cima.agrofinca.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = AgrofincaApp.class)
