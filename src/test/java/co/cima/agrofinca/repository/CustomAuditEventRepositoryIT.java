...
import co.cima.agrofinca.config.audit.AuditEventConverter;
import co.cima.agrofinca.domain.PersistentAuditEvent;
...
import static co.cima.agrofinca.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
