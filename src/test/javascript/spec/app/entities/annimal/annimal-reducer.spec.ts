...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes([REQUEST(ACTION_TYPES.FETCH_ANIMAL_LIST), REQUEST(ACTION_TYPES.FETCH_ANIMAL)], {}, state => {
        expect(state).toMatchObject({
          errorMessage: null,
          updateSuccess: false,
          loading: true,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_ANNIMAL_LIST actions', async () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_ANNIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches ACTION_TYPES.CREATE_ANNIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches ACTION_TYPES.UPDATE_ANNIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches ACTION_TYPES.DELETE_ANNIMAL actions', async () => {
      const expectedActions = [
        {
