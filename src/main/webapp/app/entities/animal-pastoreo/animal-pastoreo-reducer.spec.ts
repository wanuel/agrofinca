...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANIMALPASTOREO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANIMALPASTOREO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANIMALPASTOREO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANIMALPASTOREO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANIMALPASTOREO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANIMALPASTOREO actions', async () => {
      const expectedActions = [
        {
