...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANIMALEVENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANIMALEVENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANIMALEVENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANIMALEVENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANIMALEVENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANIMALEVENTO actions', async () => {
      const expectedActions = [
        {
