...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANIMALCOSTOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANIMALCOSTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANIMALCOSTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANIMALCOSTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANIMALCOSTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANIMALCOSTOS actions', async () => {
      const expectedActions = [
        {
