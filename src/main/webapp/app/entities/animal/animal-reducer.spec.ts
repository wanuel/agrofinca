...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './animal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANIMAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANIMAL actions', async () => {
      const expectedActions = [
        {
