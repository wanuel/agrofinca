...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './potrero-actividad-animal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POTREROACTIVIDADANIMAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_POTREROACTIVIDADANIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POTREROACTIVIDADANIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POTREROACTIVIDADANIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POTREROACTIVIDADANIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POTREROACTIVIDADANIMAL actions', async () => {
      const expectedActions = [
        {
