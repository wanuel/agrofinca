...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TIPOPARAMETRO_LIST actions', async () => {
    ...
    it('dispatches FETCH_TIPOPARAMETRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TIPOPARAMETRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TIPOPARAMETRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TIPOPARAMETRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TIPOPARAMETRO actions', async () => {
      const expectedActions = [
        {
