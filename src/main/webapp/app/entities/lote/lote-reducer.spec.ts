...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lote.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOTE actions', async () => {
      const expectedActions = [
        {
