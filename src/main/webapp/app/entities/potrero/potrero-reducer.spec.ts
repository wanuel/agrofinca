...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './potrero.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POTRERO_LIST actions', async () => {
    ...
    it('dispatches FETCH_POTRERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POTRERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POTRERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POTRERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POTRERO actions', async () => {
      const expectedActions = [
        {
