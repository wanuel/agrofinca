...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANIMALPESO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANIMALPESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANIMALPESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANIMALPESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANIMALPESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANIMALPESO actions', async () => {
      const expectedActions = [
        {
