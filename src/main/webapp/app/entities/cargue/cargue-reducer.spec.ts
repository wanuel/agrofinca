...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cargue.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARGUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARGUE actions', async () => {
      const expectedActions = [
        {
