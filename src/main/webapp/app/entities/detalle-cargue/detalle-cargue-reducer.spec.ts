...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DETALLECARGUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DETALLECARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DETALLECARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DETALLECARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DETALLECARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DETALLECARGUE actions', async () => {
      const expectedActions = [
        {
