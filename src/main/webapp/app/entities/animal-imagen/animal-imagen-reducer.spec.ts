...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANIMALIMAGEN_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANIMALIMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANIMALIMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANIMALIMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANIMALIMAGEN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANIMALIMAGEN actions', async () => {
      const expectedActions = [
        {
