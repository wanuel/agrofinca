...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './annimal.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANNIMAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANNIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANNIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANNIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANNIMAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANNIMAL actions', async () => {
      const expectedActions = [
        {
