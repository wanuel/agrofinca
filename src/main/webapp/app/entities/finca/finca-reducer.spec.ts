...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './finca.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINCA_LIST actions', async () => {
    ...
    it('dispatches FETCH_FINCA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FINCA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINCA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINCA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINCA actions', async () => {
      const expectedActions = [
        {
