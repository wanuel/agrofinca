...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './potrero-actividad.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POTREROACTIVIDAD_LIST actions', async () => {
    ...
    it('dispatches FETCH_POTREROACTIVIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POTREROACTIVIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POTREROACTIVIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POTREROACTIVIDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POTREROACTIVIDAD actions', async () => {
      const expectedActions = [
        {
