...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARAMETROS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARAMETROS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARAMETROS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARAMETROS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARAMETROS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARAMETROS actions', async () => {
      const expectedActions = [
        {
