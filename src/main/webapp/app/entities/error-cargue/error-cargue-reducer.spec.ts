...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ERRORCARGUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ERRORCARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ERRORCARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ERRORCARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ERRORCARGUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ERRORCARGUE actions', async () => {
      const expectedActions = [
        {
