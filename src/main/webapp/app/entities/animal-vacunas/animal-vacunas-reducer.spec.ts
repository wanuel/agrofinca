...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANIMALVACUNAS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANIMALVACUNAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANIMALVACUNAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANIMALVACUNAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANIMALVACUNAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANIMALVACUNAS actions', async () => {
      const expectedActions = [
        {
