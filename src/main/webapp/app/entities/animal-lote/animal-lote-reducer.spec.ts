...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANIMALLOTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ANIMALLOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ANIMALLOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ANIMALLOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ANIMALLOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ANIMALLOTE actions', async () => {
      const expectedActions = [
        {
